// Create sub-services specifically for ITR-1 service
const axios = require('axios');

const LOCAL_API_BASE_URL = 'http://localhost:8080/api/v1';

async function createITRSubServices() {
  console.log('🔧 Creating Sub-Services for ITR-1 Service...\n');
  ...
  try {
    ...
    // Create sub-services for ITR-1 using the admin endpoint
    console.log('\n2️⃣ Creating sub-services via admin endpoint...');
