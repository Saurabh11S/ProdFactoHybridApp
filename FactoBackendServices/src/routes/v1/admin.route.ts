...
router.get(
  ...
  verifyToken,
  isAdmin,
  controllers.adminController.getUserServices
);
router.get(
  "/users/:userId/consultations",
  verifyToken,
  isAdmin,
  controllers.adminController.getUserConsultations
);
router.get(
  "/services/:serviceId/users",
  verifyToken,
  isAdmin,
  controllers.adminController.getServiceUsers
);
router.get(
  "/users/:userId/services/:serviceId/documents",
  verifyToken,
  isAdmin,
...
router.get(
  ...
  verifyToken,
  isAdmin,
  controllers.adminController.getServiceConsultations
);
router.delete(
  "/users/:userId",
  verifyToken,
