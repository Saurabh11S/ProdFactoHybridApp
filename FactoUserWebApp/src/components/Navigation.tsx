          ...
          <div className="flex items-center gap-3">
            ...
            {isMobile && (
              <button
                ...
                className="w-10 h-10 bg-[#25D366] hover:bg-[#20BA5A] active:bg-[#1DA851] text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95"
