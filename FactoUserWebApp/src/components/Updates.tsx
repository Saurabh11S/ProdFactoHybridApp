...
<<<<<<< HEAD
          ...
          <button
            ...
            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#007AFF] to-[#00C897] text-white rounded-lg font-medium hover:shadow-lg transition-all duration-300 hover:scale-105"
          >
